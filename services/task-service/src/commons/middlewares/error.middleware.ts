  ...
  logger.warn(
    {
      ...
      error: { issues: error.issues, path: context.path },
      context,
    },
...
export const createRateLimitError = (
  ...
  const code =
    RATE_LIMIT_ERROR_CODES[type as keyof typeof RATE_LIMIT_ERROR_CODES] ||
    ERROR_CODES.RATE_LIMIT_EXCEEDED;

  const message =
    RATE_LIMIT_ERROR_MESSAGES[type as keyof typeof RATE_LIMIT_ERROR_MESSAGES] ||
    ERROR_MESSAGES.RATE_LIMIT_EXCEEDED;

  return createAppError(message, HTTP_STATUS.TOO_MANY_REQUESTS, code, {
    resetTimeMs,
    current,
    limit,
    type,
