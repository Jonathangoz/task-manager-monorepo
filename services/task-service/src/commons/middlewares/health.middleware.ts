 ...
 */
export const healthRequestId = (req: Request, res: Response, next: NextFunction): void => {
 ...
 */
export const healthLogger = (req: Request, res: Response, next: NextFunction): void => {
  ...
  logger.debug({
    ...
    method: req.method,
    path: req.path,
    userAgent: typeof userAgent === 'string' ? userAgent : userAgent?.[0] || 'unknown',
    ip: req.ip,
