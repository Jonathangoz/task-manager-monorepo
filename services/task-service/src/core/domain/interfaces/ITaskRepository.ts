...
export const CreateTaskDataSchema = z
  .object({
    title: z
      .string()
    ...
    priority: z
      .enum(TaskPriorityValues as [TaskPriority, ...TaskPriority[]])
      .optional(),
...
export const UpdateTaskDataSchema = z
  .object({
    title: z
      .string()
...
export const PaginationParamsSchema = z.object({
  page: z
    ...
    .min(
      ...
      `Page must be at least ${PAGINATION_CONFIG.MIN_LIMIT}`,
    )
